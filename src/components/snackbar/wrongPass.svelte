...
{#if showCodeSnippet}
    <div class="fixed bottom-0 left-0 right-0 flex items-center justify-center">
        <div class="flex items-center rounded shadow-md overflow-hidden max-w-xl relative dark:bg-gray-900 dark:text-gray-100" transition:fade>
            ...
            <div class="p-4 flex-1">
                ...
                <p class="text-sm dark:text-gray-400">Es hz kur ir kļūda bet kautkur viņa ir. Mēģiniet vēlreiz.</p>
            </div>
